...
export default function QCMquiz({number}) {
  ...
  return (
    <div className=' w-14 md:w-40 bg-white shadow-lg  border rounded-lg mt-4 relative p-3 items-center cursor-pointer'>
        ...
        <div className='hidden md:flex space-x-3 mt-3 justify-between'>
            <div className='bg-red-600 text-white text-xs p-3 text-center font-medium'>QCM</div>
            <div className='bg-blue-600 text-white text-xs p-3 text-center font-medium'>QCM</div>
        </div>
        <div className='hidden  md:flex space-x-3 mt-3 justify-between'>
            <div className='bg-yellow-400 text-white text-xs p-3 text-center font-medium'>QCM</div>
            <div className='bg-green-500 text-white text-xs p-3 text-center font-medium'>QCM</div>
        </div>
    </div>
  )
}

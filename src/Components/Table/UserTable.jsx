...
export default function UserTable() {
  return (
    ...
    <section className='mt-3 w-full flex justify-center items-center '>
        <p className='font-medium text-lg '>Total User : 16 </p>  
            ...
            <table  className=' text-sm text-left border shadow-lg w-full'>
                ...
                <tbody>
                    <tr  className='odd:bg-white even:bg-gray-50 border-b'>
                        ...
                        <td className="px-6 py-4 ">
                            <p className='line-clamp-1'>Hong Nnureach</p>
                        </td>
                        <td className="px-6 py-4 ">
                            <p className='line-clamp-1'>nureach@gmail.comn</p>
                        </td>
                        <td className="px-6 py-4 ">
                            <p className='line-clamp-1'>Student</p>
                        </td>
                        <td className="px-6 py-4 ">

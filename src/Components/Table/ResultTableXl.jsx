        ...
        </header>
        {
            data.map((item,i)=>(
                <div className='font-bold text-sm flex justify-between items-center my-6 border-b-2 pb-3'>
                    ...
                    <p className='w-48 font-medium text-gray-600 line-clamp-1'>60</p>
                    <p className='w-48'>
                    {
                        i==0 ? <button className='font-medium text-xs py-1 rounded-full px-4 text-white bg-green-500 w-1/2  my-1'>Passed</button> : (
                            i == 1 ?  <button className='font-medium text-xs py-1 rounded-full px-4 text-white bg-red-500 w-1/2  my-1'>Falied</button> :  <button className='font-medium text-xs py-1 rounded-full px-4 text-white bg-yellow-400 w-1/2  my-1'>Passed</button>
                        ) 
                    }
                    </p>
                </div>

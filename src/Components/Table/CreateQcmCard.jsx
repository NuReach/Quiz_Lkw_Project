...
export default function CreateQcmCard() {
  ...
  return (
    <div className='flex flex-col gap-9'>
        ...
        <section>
            <textarea  className='w-full rounded-md text-sm font-medium p-3 placeholder:text-gray-500' placeholder='Question Prompt'></textarea>
        </section>
        ...
        <section className='flex flex-col gap-6'>
            ...
            <div className='flex flex-wrap gap-6 items-center'>
                ...
                <input type="text" className='p-2 text-xs rounded-md' />

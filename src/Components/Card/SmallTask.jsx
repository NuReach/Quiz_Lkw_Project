  ...
  return (
    <div className='w-full hidden p-6 shadow-lg rounded-lg border sm:block sm:w-60 mt-6 lg:w-80 xl:hidden'>
                                <div className=' flex justify-between items-center'>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="32" viewBox="0 0 14 14"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><circle cx="7" cy="2" r="1.5"/><circle cx="7" cy="7" r="1.5"/><circle cx="7" cy="12" r="1.5"/></g></svg>
                                </div>

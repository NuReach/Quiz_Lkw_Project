...
export default function Search({name}) {
  ...
  return (
    <div className=' relative mt-3 mb-1 max-w-96 w-full border-2 bg-white rounded-md sm:w-96 '>
        <input onKeyDown={submit}  type="text" className='border-none w-10/12 h-8 rounded-md focus:ring-0  placeholder:text-xs text-xs font-medium focus:border-gray-400 border-gray-400' placeholder={`Search for ${name} here`} />

  ...
  return (
    <div className='flex items-center flex-wrap relative'>
      ...
      <div className= {filter ? 'flex flex-wrap items-center' : 'hidden' }>
          ...
          <button onClick={(e)=>clickFilter(e,"time")} className='rounded-full mr-3 my-1 border-2 py-1 px-8 bg-white font-medium text-xs cursor-pointer hover:scale-105 transition'>Time</button>
      </div>

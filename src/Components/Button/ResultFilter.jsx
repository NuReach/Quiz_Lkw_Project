...
export default function ResultFilter() {
    ...
    return (
      <div className='flex items-center flex-wrap relative'>
          ...
          <button className='rounded-full mr-3 my-1 border-2 py-1 px-8 bg-white font-medium text-xs cursor-pointer hover:scale-105 transition'>Latest</button>
        <div className= {filter ? 'flex flex-wrap items-center' : 'hidden' }>
            ...
            <button className='rounded-full mr-3 my-1 border-2 py-1 px-8 bg-white font-medium text-xs cursor-pointer hover:scale-105 transition'>Course</button>
            <button className='rounded-full mr-3 my-1 border-2 py-1 px-8 bg-white font-medium text-xs cursor-pointer hover:scale-105 transition'>Score</button>
        </div>
